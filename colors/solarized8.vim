...
" Last Updated: Sat 28 Aug 2021 19:15:09 BST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  elseif get(g:, 'solarized_visibility', '') ==# 'low'
    ...
    hi CursorLineNr guifg=#fdf6e3 guibg=#eee8d5 gui=bold cterm=bold
    ...
    hi SpellBad guifg=NONE guibg=NONE guisp=#dc322f gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi SpellCap guifg=NONE guibg=NONE guisp=#268bd2 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi SpellLocal guifg=NONE guibg=NONE guisp=#859900 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi SpellRare guifg=NONE guibg=NONE guisp=#b58900 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi Title guifg=#cb4b16 guibg=NONE gui=bold cterm=bold
  endif
  if s:termtrans
    hi CursorLineNr guibg=NONE
  ...
  elseif get(g:, 'solarized_statusline', '') ==# 'flat'
    ...
    hi StatusLine guifg=#eee8d5 guibg=#839496 gui=reverse cterm=reverse
    hi StatusLineNC guifg=#eee8d5 guibg=#586e75 gui=reverse cterm=reverse
    hi TabLine guifg=#93a1a1 guibg=#eee8d5 gui=NONE cterm=NONE
    hi TabLineFill guifg=#93a1a1 guibg=#eee8d5 gui=NONE cterm=NONE
    hi TabLineSel guifg=#073642 guibg=#eee8d5 gui=NONE cterm=NONE
  ...
  hi Conceal guifg=#eee8d5 guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  elseif get(g:, 'solarized_visibility', '') ==# 'low'
    ...
    hi CursorLineNr ctermfg=230 ctermbg=254 cterm=bold
  ...
  elseif get(g:, 'solarized_statusline', '') ==# 'flat'
    ...
    hi StatusLine ctermfg=254 ctermbg=246 cterm=reverse
    hi StatusLineNC ctermfg=254 ctermbg=242 cterm=reverse
    hi TabLine ctermfg=247 ctermbg=254 cterm=NONE
    hi TabLineFill ctermfg=247 ctermbg=254 cterm=NONE
    hi TabLineSel ctermfg=236 ctermbg=254 cterm=NONE
...
if s:t_Co >= 16
  ...
  elseif get(g:, 'solarized_statusline', '') ==# 'flat'
    ...
    hi StatusLine ctermfg=7 ctermbg=12 cterm=reverse
    hi StatusLineNC ctermfg=7 ctermbg=10 cterm=reverse
    hi TabLine ctermfg=14 ctermbg=7 cterm=NONE
    hi TabLineFill ctermfg=14 ctermbg=7 cterm=NONE
    hi TabLineSel ctermfg=0 ctermbg=7 cterm=NONE
